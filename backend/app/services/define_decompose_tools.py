...
This tool identifies the fundamental building blocks of a problem — the core components
that cannot be further simplified. Use different decomposition approaches like:
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "approach": {
                    "type": "string",
                    "description": (
                        "The decomposition approach being used "
                        "(e.g., 'functional', 'structural', 'causal', 'temporal')"
                    )
                },
                "fundamentals": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": (
                        "The irreducible elements identified — each a concise statement "
                        "of a core component, constraint, or relationship"
                    ),
                    "minItems": 1
                }
            },
            ...
            "properties": {
                "domain": {
                    ...
                    "description": (
                        ...
                        "(e.g., 'machine learning optimization', 'urban transportation')"
                    )
                },
                "key_findings": {
                    "type": "array",
                        ...
                        "properties": {
                            "text": {
                                ...
                                "description": (
                                    ...
                                    "(e.g., 'Transportation must be individually owned')"
                                )
                            },
                            "source": {
                                "type": "string",
                                "description": (
                                    "Where this assumption comes from (e.g., 'current market structure', "
                                    "'problem statement', 'industry standard practice')"
                                )
                            },
                            "options": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": (
                                    "2-4 contextual response options for this assumption. "
                                    "Each option represents a distinct stance "
                                    "(e.g., confirm, nuance, challenge). "
...
Each reframing should feel like looking at the same problem through a different lens,
potentially revealing overlooked opportunities.

RESONANCE ASSESSMENT: You MUST generate a resonance_prompt (question probing how this
reframing shifts the user's thinking) and resonance_options (3-4 graduated options).
Option 0 MUST be a "doesn't shift my perspective" variant. Options 1+ represent increasing
resonance. The user's selection tells Phase 2 HOW the reframing shifted their thinking,
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "reasoning": {
                    "type": "string",
                    "description": (
                        "Why this reframing might reveal new solutions — "
                        "what shift in perspective does it create?"
                    )
                },
                "resonance_prompt": {
                    "type": "string",
                    "description": (
                        "A question probing how this reframing shifts the user's perspective "
                        "on their problem. Example: 'Does viewing transportation as an information "
                        "coordination problem change how you think about your routing challenge?'"
                    )
                },
                "resonance_options": {
                    "type": "array",
                    "items": {"type": "string"},
                    "description": (
                        "3-4 options from 'no perspective shift' to 'fundamentally changes how I "
                        "see the problem'. Option 0 MUST be a 'doesn't shift my perspective' variant. "
                        "Example: ['Doesn\\'t shift my perspective', "
                        "'Interesting but doesn\\'t change my approach', "
                        "'Opens a new angle I hadn\\'t considered', "
                        "'Completely changes how I see the problem']"
                    ),
                    "minItems": 3,
                    "maxItems": 4
                }
            ...
            "required": [
                "reframing_text", "reframing_type", "reasoning",
                "resonance_prompt", "resonance_options"
            ]
        }
    }
]
